...
local whatsapp_app_tag = "whatsapp_app" -- Pandora: ZapZap em special:whatsapp
...
tagged_rule(opaque_tag, {
    "foot",                          -- Terminal
    "equibop|equicord",              -- Discord clients (Pandora: equicord)
...
tagged_rule(communication_app_tag, {
    "discord|equibop|equicord|vesktop", -- Discord clients (Pandora: equicord)
    "whatsapp"                          -- Whatsapp (genérico)
}, "class")
tagged_rule(whatsapp_app_tag, {
    "zapzap" -- Pandora: ZapZap → special:whatsapp
}, "class")
tagged_rule(todo_app_tag, {
    "todoist|Todoist|io.github.alainm23.planify|planify|Planify" -- Pandora: Planify
}, "class")
...
create_tag(whatsapp_app_tag, { workspace = "special:whatsapp" }) -- Pandora
